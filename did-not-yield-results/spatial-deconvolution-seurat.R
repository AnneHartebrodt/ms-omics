...
out.dir<- file.path('/work/AnneSophiaHartebrodt#6698/ms-project/submission/results-final/ms-rna-spatial/deconvolution_seurat')
...
adata$seurat_string<-as.character(adata$seurat_clusters)

sc_meta<-adata@meta.data


Idents(adata)<-'seurat_string'
